...
fun NavigationDrawer(
    ...
    Column(
        ...
        Column {
            Text(
                text = if (role == User.UserRole.ADMIN) "Menú Administrador" else "Menú Usuario",
            ...
            DrawerItem("Predicciones", "visualizar_predicciones", Icons.Default.ShowChart, selectedItem, onItemClick)
        }
